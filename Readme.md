...
I am a Middle Golang Backend Developer, passionate about building high-performance and scalable systems.  
...
- [How to easily use Redis functions in Go](https://medium.com/@komronhosimov524/how-to-easily-use-redis-functions-in-go-cc36190ab763)
<!-- BLOG-POST-LIST:END -->
...
### ✨ About Me
I am a Middle Golang Developer with 3+ years of experience building **high-performance, scalable backend systems**. I specialize in **concurrency, microservices, and distributed systems**.  

I actively contribute to open-source projects, write about performance optimizations, and mentor junior developers in Go best practices.
...
<p align="left">
  ...
  <a href="https://rabbitmq.com/" target="_blank"><img src="https://www.vectorlogo.zone/logos/rabbitmq/rabbitmq-icon.svg" alt="RabbitMQ" width="40" height="40"/></a>
...
### 💻 Projects
- [YouMeal](https://github.com/koma2211/you-meal) – YouMeal fastfood web-site project, Golang, PostgreSQL, Redis, Docker, Docker-Compose

[⏩ &nbsp;More projects](https://github.com/koma2211?tab=repositories)

---

### 🏆 Achievements
- Built distributed systems handling **100k+ requests per day**  
- Optimized PostgreSQL queries, reducing latency **up to 60%**  
- Contributor to multiple **open-source Go libraries**  
- Speaker at local Golang meetups and workshops  
